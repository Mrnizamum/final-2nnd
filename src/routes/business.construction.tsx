  ...
  return (
    ...
    >
      <div className="lp-prose space-y-4">
        <p>At AtS Construction &amp; Engineering Pte. Ltd., we provide comprehensive general construction services supported by strong technical capability and experienced project execution teams. Our scope covers industrial, commercial, and infrastructure development projects, delivered with a strong focus on safety, quality, and timely completion.</p>
        ...
        <p>With a skilled workforce, strong project management capability, and commitment to excellence, AtS delivers general construction and infrastructure solutions that support the successful development and long-term performance of industrial facilities across Singapore and the region.</p>
      </div>
    </PageLayout>
  );
}
