  ...
  return (
    ...
    >
      <div className="lp-prose space-y-4">
        ...
        <p>With a strong focus on safety, quality, and schedule adherence, our experienced project teams ensure smooth coordination across all disciplines and seamless integration of mechanical systems. Through disciplined execution, skilled manpower, and proven site experience, AtripleS delivers reliable EPC mechanical solutions that meet client expectations and industry standards.</p>
      </div>
    </PageLayout>
  );
}
