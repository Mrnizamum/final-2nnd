...
export const Route = createFileRoute("/about/governance")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Code of conduct, integrity, HSE responsibilities and ethical business commitments at AtripleS." },
    ],
  }),
  ...
  return (
    ...
    >
      <div className="lp-prose space-y-5">
        ...
        <p>At AtripleS Construction &amp; Engineering Pte. Ltd., we are committed to conducting all business activities with integrity, transparency, and professionalism. This Code of Conduct applies to all employees, subcontractors, and representatives of the company.</p>
        ...
        <p>Any violation of this Code must be reported to management. AtripleS ensures confidentiality and proper handling of all reports.</p>

        <h2 className="lp-h text-lg">Our Commitment</h2>
        <p>AtripleS Construction &amp; Engineering Pte. Ltd. is committed to maintaining high ethical standards, strong governance, and trusted partnerships in every project we undertake.</p>
      </div>
    </PageLayout>
  );
}
